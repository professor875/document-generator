...
function mapFormDataToFields(formData: Record<string, string>): DocumentFields {
  ...
  return {
    ...
    claimHeading: getField('claimHeading'),
    accidentHeading: getField('accidentHeading'),
    accidentLegalText: getField('accidentLegalText'),
    medicalHeading: getField('medicalHeading'),
    remediesHeading: getField('remediesHeading'),
    specialDamagesHeading: getField('specialDamagesHeading'),
    generalDamagesHeading: getField('generalDamagesHeading'),
    expertRequestHeading: getField('expertRequestHeading'),
    expertRequestBody: getField('expertRequestBody'),
    expertRequestNote: getField('expertRequestNote'),
    ...
    medicalTreatmentsText: getField('medicalTreatmentsText'),
