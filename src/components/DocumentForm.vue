...
const HIDE_LABEL_GROUPS = new Set(['פרטי עורך הדין', 'הזמנה לדין', 'טיפולים רפואיים', 'סעדים נדרשים', 'נזקים מיוחדים', 'נזקים כלליים', 'סיכום ובקשות', 'חתימת עורך הדין', 'עמוד 5 - כותרת', 'עמוד 5 - בקשה וחתימה'])
